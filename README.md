...
- 专业级 K 线图：指标图例（MA5/MA20/BOLL/MACD/KDJ/RSI 当前值、颜色与线条一致）、十字光标 OHLC 读数、全屏弹窗垂直居中
- 智能分析工作台：多模型并行 AI 研判（DeepSeek/MiniMax/通义/Kimi/OpenAI 等一键预设）、研究简报随会话本地留存、随机因子（全球市场/国内市场/政策面等 tag 可勾选，支持 AI 评审增量更新因子目录）、共识买入/卖出/持有/观望信号
